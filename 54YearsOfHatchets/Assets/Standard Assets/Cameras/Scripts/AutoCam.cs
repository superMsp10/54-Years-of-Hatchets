...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(new Vector3(transform.position.x, transform.position.y + y_offset, transform.position.z), m_Target.position, deltaTime * m_MoveSpeed);
